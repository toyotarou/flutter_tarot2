...
class _$HistoryStateCopyWithImpl<$Res, $Val extends HistoryState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      historyDateMap: null == historyDateMap
          ? _value.historyDateMap
          : historyDateMap // ignore: cast_nullable_to_non_nullable
              as Map<String, int>,
      historyIdMap: null == historyIdMap
          ? _value.historyIdMap
...
class _$HistoryStateImpl implements _HistoryState {
  ...
  final Map<String, int> _historyDateMap;
  @override
  @JsonKey()
  Map<String, int> get historyDateMap {
    if (_historyDateMap is EqualUnmodifiableMapView) return _historyDateMap;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_historyDateMap);
  }

  final Map<int, List<String>> _historyIdMap;
  @override
  @JsonKey()
  Map<int, List<String>> get historyIdMap {
    if (_historyIdMap is EqualUnmodifiableMapView) return _historyIdMap;
    // ignore: implicit_dynamic_type
